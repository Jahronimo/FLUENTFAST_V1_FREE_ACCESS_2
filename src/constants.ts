...
export const COLORS = {
  ...
  WHITE: '#FFFFFF',
  BLACK: '#000000',
  UNDERLINES: ['#FFFF00', '#FF69B4', '#89CFF0']
};
...
const datasetAuthoritative = [
  ...
  { index: 15, en: ["Meet new friends?", "Sounds great.", ["friends", "great"]], es: ["¿Conocer nuevos amigos?", "Suena genial.", ["amigos", "genial"]], fr: ["Rencontrer de nouveaux amis ?", "Ça a l’air genial.", ["amis", "genial"]], de: ["Neue Freunde treffen?", "Klingt großartig.", ["Freunde", "großartig"]] },
  ...
  { index: 76, en: ["So, everywhere in the house?", "Exactly.", ["house", "Exactly"]], es: ["Entonces, ¿en toda la casa?", "Exactamente.", ["casa", "Exactamente"]], fr: ["Donc, partout dans the maison ?", "Exactement.", ["maison", "Exactement"]], de: ["Also überall im Haus?", "Genau.", ["Haus", "Genau"]] },
  ...
  { index: 83, en: ["We can try testing each other?", "Is this good?", ["testing", "good"]], es: ["¿Podemos intentar evaluarnos?", "¿Esto es bueno?", ["evaluarnos", "bueno"]], fr: ["On peut essayer de se tester ?", "C’est bien ?", ["tester", "bien"]], de: ["Wir können versuchen, uns gegenseitig testen?", "Ist das gut?", ["testen", "gut"]] },
  ...
  { index: 85, en: ["To help speaking and listening.", "This is very important.", ["help", "important"]], es: ["Para ayudar a hablar y escuchar.", "Esto es muy importante.", ["ayudar", "importante"]], fr: ["Para ayudar a hablar et écouter.", "C’est très important.", ["aider", "importante"]], de: ["Um beim Sprechen und Zuhören zu helfen.", "Das ist sehr wichtig.", ["helfen", "wichtig"]] },
...
function resolveFallback(text: string): string {
  if (!text) return "";
...
export const PHRASES: PhrasePair[] = datasetAuthoritative.map((step) => {
  ...
  const getAnchorsForRole = (roleIdx: 0 | 1): SemanticAnchor[] => {
    ...
    if (filteredEn.length === 0) {
      return [{
        [Language.ENGLISH]: resolveFallback(en[roleIdx]),
        [Language.SPANISH]: resolveFallback(es[roleIdx]),
        [Language.FRENCH]: resolveFallback(fr[roleIdx]),
        [Language.GERMAN]: resolveFallback(de[roleIdx]),
      }];
    }
    ...
    return filteredEn.map(anchorEn => {
      ...
      return {
        ...
        [Language.SPANISH]: es[2]?.[globalIdx] || resolveFallback(es[roleIdx]),
        [Language.FRENCH]: fr[2]?.[globalIdx] || resolveFallback(fr[roleIdx]),
        [Language.GERMAN]: de[2]?.[globalIdx] || resolveFallback(de[roleIdx]),
      };
    });
  };
...
/**
 * Icons defined using React.createElement to avoid JSX parsing errors in .ts files
 */
export const Icons = {
  Back: () => React.createElement('svg', { viewBox: "0 0 24 24", width: "32", height: "32", fill: "currentColor" },
    React.createElement('path', { d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z" })
  ),
  Next: () => React.createElement('svg', { viewBox: "0 0 24 24", width: "32", height: "32", fill: "currentColor" },
    React.createElement('path', { d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z" })
  ),
  Exit: () => React.createElement('svg', { viewBox: "0 0 24 24", width: "32", height: "32", fill: "currentColor" },
    React.createElement('path', { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" })
  ),
  Test: () => React.createElement('svg', { viewBox: "0 0 24 24", width: "32", height: "32", fill: "currentColor" },
    React.createElement('path', { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" })
  ),
  Instagram: () => React.createElement('svg', { viewBox: "0 0 24 24", fill: "currentColor" },
  ...
  TikTok: () => React.createElement('svg', { viewBox: "0 0 24 24", fill: "currentColor" },
