...
import flyingKoalaData from './assets/illustrations/Koalas_flying.json';
...
const App: React.FC = () => {
  ...
  const handleNavigate = useCallback((next: Page) => {
    ...
    // Direct transition for data-heavy views to avoid frame drops
        ...
        return (
          <div className="relative flex flex-col items-center justify-center h-full w-full overflow-hidden" style={{ backgroundColor: COLORS.BRAND_BLUE }}>
            <div className="absolute top-[10vh] z-10 h-[30vh] w-[30vh] animate-float flex items-center justify-center">
              <Lottie animationData={flyingKoalaData} loop className="w-full h-full" />
            </div>
            <div className="relative z-20 w-full h-full px-[3vw] flex flex-col items-center justify-center">
              ...
              <button 
                ...
                style={{ backgroundColor: isKoalaButtonPressed ? COLORS.WHITE : COLORS.BRAND_BLUE, color: isKoalaButtonPressed ? COLORS.BRAND_BLUE : COLORS.WHITE }}
              >
            ...
            <div className="absolute bottom-12 left-0 right-0 flex justify-center items-center space-x-4 pointer-events-auto z-10">
              <a href="https://www.instagram.com/fluentfast_koalas/" target="_blank" rel="noopener noreferrer" className="btn-tactile text-white w-[22px] h-[22px] social-icon-animate" style={{ animationDelay: '1.8s' }}><Icons.Instagram /></a>
              <a href="https://www.tiktok.com/@fluentfast_koalas" target="_blank" rel="noopener noreferrer" className="btn-tactile text-white w-[22px] h-[22px] social-icon-animate" style={{ animationDelay: '2.5s' }}><Icons.TikTok /></a>
            </div>
          </div>
        );
      case 'PARTNER':
